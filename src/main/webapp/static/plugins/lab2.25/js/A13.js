window.addEventListener('scroll', (e) => {
    ...
    console.log("scrollTop:"+document.documentElement.scrollTop+";scrollHeight:"+document.documentElement.scrollHeight+";clientHeight:"+document.documentElement.clientHeight+";scrolled:"+scrolled);
