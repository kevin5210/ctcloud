...
$('[data-mod-id="seo-bottom"] .pep-service-entrance .por-section').attr("style", "background-image:url(https://www.huaweicloud.com/content/dam/cloudbu-site/archive/china/zh-cn/about/events/ad.png)");
